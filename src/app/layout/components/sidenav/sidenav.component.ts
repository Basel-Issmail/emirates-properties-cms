  ...
  sideNavItems = [
    {
      ...
      children: [
        ...
        { title: 'Agent profile', permission: ['Agent'], url: '/agent-profile', icon: 'support_agent' }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        { title: 'Contact us info', permission: ['admin'], url: '/contact-us', icon: 'perm_contact_calendar' },
